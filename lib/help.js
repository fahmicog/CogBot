...
Contoh : *${prefix}tiktokstalk @fahmicog*

*[@username]* Diisi dengan Username yang valid tanpa tanda “[” dan “]”
Contoh : *${prefix}igstalk @fahmicog*

*[@username]* Diisi dengan Username yang valid tanpa tanda “[” dan “]”
Contoh : *${prefix}smulestalk @fahmicog*
...
Contoh : *${prefix}googlesearch siapa itu COG*
...
╠➥ *NAME : COG BOT*
╠➥ *VERSION : 3.4*
╠➥ *GITHUB : github.com/fahmicog*
╠➥ *WEBSITE : www.fahmicog.site*
║
╚═〘 COG BOT 〙
`
}
...
exports.info = info
const snk = () => {
    return `Syarat dan Ketentuan Bot *COG*
...
║
╠➥ *DONASI BISA MELALUI :*
╠➥ *DANA/PULSA/OVO : 083129621297*
╠➥ *PAYPAL : fahmicog@gmail.com*
╠➥ *SAWERIA : saweria.co/fahmicog*
